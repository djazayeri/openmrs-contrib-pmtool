angular.module("scrum", ["ngResource", "ui.router", "nvd3"])
        ...
        .controller("WeekController", ["$scope", "$state", "$resource", "$http", function ($scope, $state, $resource,
                                                                                           $http) {
        ...
        .controller("PmOverviewController", ["$scope", "$http", "needsAttentionStatuses", function ($scope, $http,
            ...
            doJiraQuery("nextRefappRelease",
                        ...
                        'project = RA and fixVersion = "Reference Application 2.11.0"',
                        {
                            showNum: 0,
                            bigNumber: false,
                            minExpected: 1
            ...
            doJiraQuery("nextPlatformMaintenenceRelease",
                        "Platform 2.3.2 Maintenance Release",
                        'project = TRUNK and fixVersion = "Platform 2.3.2"',
                        {
                            showNum: 0,
                            bigNumber: false,
                            minExpected: 1
            ...
            doJiraQuery("nextPlatformRelease",
                        "Platform 2.4.0",
                        'project = TRUNK and fixVersion = "Platform 2.4.0"',
                        {
                            showNum: 0,
                            bigNumber: false,
                            minExpected: 1
